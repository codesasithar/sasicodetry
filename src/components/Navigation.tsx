...
const Hero = () => {
  ...
  // Extracted Profile Image Component to prevent duplicate code block styling
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 gradient-hero">
        ...
        {/* Profile Picture - Desktop Only Top Left Corner Placement */}
        <div
          className="absolute top-16 left-12 z-30 animate-fade-in pointer-events-none hidden lg:block"
      ...
      {/* Content Wrapper - Padded cleanly away from top site Nav Bar on mobile devices */}
      <div className="section-container relative z-20 px-4 sm:px-6 lg:px-8 pt-28 sm:pt-36 lg:pt-0">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="hidden lg:grid lg:grid-cols-2 gap-12 xl:gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex justify-center lg:justify-start space-x-3 sm:space-x-4 animate-fade-in" style={{ animationDelay: "1s" }}>
                <a href="https://linkedin.com/in/sasitharcodes" target="_blank" rel="noopener noreferrer" className="p-2 sm:p-3 bg-card/50 rounded-lg text-muted-foreground hover:text-primary hover:bg-card transition-all cursor-magnetic cursor-glow ripple-effect">
                  <Linkedin className="h-4 w-4 sm:h-5 sm:w-5" />
                </a>
                <a href="https://github.com/codesasithar/Projects" target="_blank" rel="noopener noreferrer" className="p-2 sm:p-3 bg-card/50 rounded-lg text-muted-foreground hover:text-primary hover:bg-card transition-all cursor-magnetic cursor-glow ripple-effect">
                  <Github className="h-4 w-4 sm:h-5 sm:w-5" />
                </a>
                <a href="https://www.instagram.com/sasitharm/" target="_blank" rel="noopener noreferrer" className="p-2 sm:p-3 bg-card/50 rounded-lg text-muted-foreground hover:text-primary hover:bg-card transition-all cursor-magnetic cursor-glow ripple-effect">
                  <Instagram className="h-4 w-4 sm:h-5 sm:w-5" />
                </a>
                <a href="https://www.facebook.com/snazzy.sasithar" target="_blank" rel="noopener noreferrer" className="p-2 sm:p-3 bg-card/50 rounded-lg text-muted-foreground hover:text-primary hover:bg-card transition-all cursor-magnetic cursor-glow ripple-effect">
                  <Facebook className="h-4 w-4 sm:h-5 sm:w-5" />
                </a>
                <a href="tel:+919443798476" className="p-2 sm:p-3 bg-card/50 rounded-lg text-muted-foreground hover:text-primary hover:bg-card transition-all cursor-magnetic cursor-glow ripple-effect">
            ...
            <div className="flex flex-col items-center lg:items-end animate-fade-in" style={{ animationDelay: "0.3s" }}>
              <div className="relative">
                ...
                <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-[420px] lg:h-[320px] rounded-2xl sm:rounded-3xl overflow-hidden border-2 sm:border-4 border-primary/30">
                  <video src="/videos/skills-video.mp4" loop playsInline controls className="w-full h-full object-cover" />
          ...
          <div className="lg:hidden flex flex-col items-center text-center space-y-6 sm:space-y-8">
            ...
            {/* MOBILE FIX: Profile picture sits inline nicely below navigation instead of floating over it */}
            <div className="animate-fade-in mb-2" style={{ animationDelay: "0.5s" }}>
              <ProfileImageElement />
            </div>
